...
<vxml version="2.0">	
    ...
    <menu id="menuCategory">
        ...
        <choice next="#hardware" dtmf="1">Technical .</choice>
        <choice next="#web" dtmf="2">Non Technical.</choice>        
        <choice next="#software" dtmf="3">Data Processing.</choice> 
    ...
    <%
            ...
            try {
                ...
                rst = stmt.executeQuery("SELECT DATE_FORMAT(date,'%e-%m-%Y'),companyname,position,eligibility,location FROM technical");
                while (rst.next()) {
                       %>
                }    
    <form id="hardware">
    ...
    <%
            ...
            try {
                ...
                rst1 = stmt1.executeQuery("SELECT DATE_FORMAT(date,'%e-%m-%Y'),companyname,position,eligibility,location FROM nontechnical");
                while (rst1.next()) {
    %>
    <form id="web">
        <block>
    ...
    <%
       String driver2 = "com.mysql.jdbc.Driver";
            ...
            try {
                ...
                rst2 = stmt2.executeQuery("SELECT DATE_FORMAT(date,'%e-%m-%Y'),companyname,position,eligibility,location FROM data");
                while (rst2.next()) {
    %>
    <form id="software">
        <block>
